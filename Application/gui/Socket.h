...
static int interrupted, port = 8787, ssl_connection = LCCSCF_USE_SSL;
...
static int callback_minimal_pingtest(
  struct lws* wsi,
...
static const struct lws_protocols protocols[] = {
  {"lws-ping-test", callback_minimal_pingtest, 0, 0, 0, NULL, 0},
